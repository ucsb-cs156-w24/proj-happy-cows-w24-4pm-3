...
describe("AnnouncementTable tests", () => {
  ...
  test("Has the expected column headers, content and buttons for admin user", () => {
    ...
    expect(screen.getByTestId(`${testId}-cell-row-0-col-start`)).toHaveTextContent("2022-03-05T15:50:10");

    expect(screen.getByTestId(`${testId}-cell-row-1-col-id`)).toHaveTextContent("2");
    expect(screen.getByTestId(`${testId}-cell-row-1-col-start`)).toHaveTextContent("2012-03-05T15:50:10");
